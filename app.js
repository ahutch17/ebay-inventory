...
function staleness(days) {
  if (days <= 13) return { color: "#748067", ring: "#748067" };
  if (days <= 30) return { color: "#9CA290", ring: "#9CA290" };
  return { color: "#A9887B", ring: "#A9887B" };
}
const emptyDraft = () => ({
  id: null,
  itemNumber: "",
...
function ListingTracker() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Inter', sans-serif" }, className: "min-h-screen bg-[#E9DBCE] text-[#2F3730]" }, /* @__PURE__ */ React.createElement("header", { className: "border-b-2 border-[#2F3730] bg-[#E9DBCE] sticky top-0 z-20" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-4xl mx-auto px-5 py-5 flex items-center justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-11 h-11 rounded-full border-2 border-[#A9887B] flex items-center justify-center flex-shrink-0", style: { transform: "rotate(-8deg)" } }, /* @__PURE__ */ React.createElement(Stamp, { size: 20, strokeWidth: 2, className: "text-[#A9887B]" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "'Oswald', sans-serif", letterSpacing: "0.02em" }, className: "text-2xl font-semibold uppercase leading-none" }, "The Manifest"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-[#6B6152] mt-1 font-medium" }, "Listing freshness & SEO tracker"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        setImportResult(null);
      ...
      className: "flex items-center gap-1.5 bg-white border border-[#2F3730] text-[#2F3730] px-3.5 py-2.5 rounded-sm text-sm font-semibold hover:bg-[#F4F0E4] transition-colors",
    ...
    {
      onClick: openNew,
      className: "flex items-center gap-1.5 bg-[#2F3730] text-[#E9DBCE] px-4 py-2.5 rounded-sm text-sm font-semibold hover:bg-[#455142] transition-colors",
      style: { fontFamily: "'Oswald', sans-serif", letterSpacing: "0.03em" }
    },
    /* @__PURE__ */ React.createElement(Plus, { size: 16, strokeWidth: 2.5 }),
    " ADD ITEM"
  )))), /* @__PURE__ */ React.createElement("main", { className: "max-w-4xl mx-auto px-5 py-6 pb-24" }, loaded && listings.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2 mb-6" }, /* @__PURE__ */ React.createElement(StatBlock, { label: "Tracked", value: stats.total }), /* @__PURE__ */ React.createElement(StatBlock, { label: "Stale (30d+)", value: stats.stale, accent: "#A9887B" }), /* @__PURE__ */ React.createElement(StatBlock, { label: "Updated this week", value: stats.updatedThisWeek, accent: "#748067" }), /* @__PURE__ */ React.createElement(StatBlock, { label: "Flagged", value: stats.flagged, accent: "#9CA290" })), saveError && /* @__PURE__ */ React.createElement("div", { className: "mb-4 text-sm bg-[#EBDFD6] border border-[#A9887B] text-[#6B564C] px-3 py-2 rounded-sm" }, "Couldn't save \u2014 your browser's local storage may be full or disabled for this file."), loaded && listings.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 bg-white border border-[#D2C4B4] rounded-sm px-3 py-2 flex-1 min-w-[160px]" }, /* @__PURE__ */ React.createElement(Search, { size: 15, className: "text-[#8C8878] flex-shrink-0" }), /* @__PURE__ */ React.createElement(
    "input",
    {
      value: query,
      onChange: (e) => setQuery(e.target.value),
      placeholder: "Search title or SKU",
      className: "bg-transparent outline-none text-sm w-full placeholder:text-[#B7AC9B]"
    }
  )), /* @__PURE__ */ React.createElement(
    "select",
    {
      ...
      className: "border border-[#D2C4B4] bg-white rounded-sm px-3 py-2 text-sm font-medium outline-none",
  ...
  )), loaded && listings.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-center py-16 px-6 border-2 border-dashed border-[#D2C4B4] rounded-sm" }, /* @__PURE__ */ React.createElement("div", { className: "w-14 h-14 rounded-full border-2 border-[#B7AC9B] mx-auto mb-4 flex items-center justify-center", style: { transform: "rotate(-6deg)" } }, /* @__PURE__ */ React.createElement(Stamp, { size: 24, className: "text-[#B7AC9B]" })), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Oswald', sans-serif" }, className: "text-lg font-semibold uppercase mb-1" }, "Nothing on the manifest yet"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-[#6B6152] mb-5 max-w-sm mx-auto" }, "Add your first listing to start tracking when it was last touched and what it still needs."), /* @__PURE__ */ React.createElement("button", { onClick: openNew, className: "inline-flex items-center gap-1.5 bg-[#2F3730] text-[#E9DBCE] px-4 py-2.5 rounded-sm text-sm font-semibold", style: { fontFamily: "'Oswald', sans-serif", letterSpacing: "0.03em" } }, /* @__PURE__ */ React.createElement(Plus, { size: 16, strokeWidth: 2.5 }), " ADD YOUR FIRST ITEM")), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, filtered.map((l) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: l.id, className: "bg-white border border-[#D2C4B4] rounded-sm overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-stretch" }, /* @__PURE__ */ React.createElement("div", { className: "flex-shrink-0 w-20 flex items-center justify-center border-r border-dashed border-[#D2C4B4] py-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-14 h-14 rounded-full border-2 flex flex-col items-center justify-center", style: { borderColor: st.ring, transform: "rotate(-5deg)" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "'IBM Plex Mono', monospace", color: st.color }, className: "text-base font-semibold leading-none" }, days), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "'IBM Plex Mono', monospace", color: st.color }, className: "text-[8px] uppercase tracking-wide leading-none mt-1" }, "days"))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0 px-4 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("p", { className: "font-semibold text-sm truncate" }, l.title), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "'IBM Plex Mono', monospace" }, className: "text-xs text-[#8C8878] mt-0.5" }, l.sku || "no sku", " ", l.category ? `\xB7 ${l.category}` : "")), /* @__PURE__ */ React.createElement(PriorityTag, { priority: l.priority })), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mt-2 flex-wrap" }, needsWorkCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-xs font-medium text-[#A9887B] bg-[#EBDFD6] px-2 py-0.5 rounded-sm" }, needsWorkCount, " field", needsWorkCount > 1 ? "s" : "", " flagged"), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-[#8C8878]" }, "SEO checklist ", seoDone, "/", SEO_CHECKLIST_FIELDS.length)), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mt-3 flex-wrap" }, /* @__PURE__ */ React.createElement("button", { onClick: () => markUpdatedToday(l.id), className: "text-xs font-semibold uppercase tracking-wide bg-[#2F3730] text-[#E9DBCE] px-3 py-1.5 rounded-sm hover:bg-[#455142]", style: { fontFamily: "'Oswald', sans-serif" } }, "Mark updated today"), /* @__PURE__ */ React.createElement("button", { onClick: () => setExpandedId(expanded ? null : l.id), className: "text-xs font-medium text-[#6B6152] flex items-center gap-0.5 px-2 py-1.5" }, "Details ", expanded ? /* @__PURE__ */ React.createElement(ChevronUp, { size: 14 }) : /* @__PURE__ */ React.createElement(ChevronDown, { size: 14 })), /* @__PURE__ */ React.createElement("button", { onClick: () => editListing(l), className: "text-xs font-medium text-[#6B6152] px-2 py-1.5" }, "Edit"), /* @__PURE__ */ React.createElement("button", { onClick: () => deleteListing(l.id), className: "text-xs font-medium text-[#A9887B] px-2 py-1.5 ml-auto flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Trash2, { size: 13 }))))), expanded && /* @__PURE__ */ React.createElement("div", { className: "border-t border-[#D2C4B4] bg-[#F3EEE6] px-4 py-4 grid sm:grid-cols-2 gap-5" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "'Oswald', sans-serif" }, className: "text-xs font-semibold uppercase tracking-wide text-[#6B6152] mb-2" }, "Needs work"), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, NEEDS_WORK_FIELDS.map((f) => {
      var _a;
      return /* @__PURE__ */ React.createElement("label", { key: f.key, className: "flex items-center gap-2 text-sm cursor-pointer" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: !!((_a = l.needsWork) == null ? void 0 : _a[f.key]), onChange: () => toggleNeedsWork(l.id, f.key), className: "accent-[#A9887B] w-4 h-4" }), f.label);
    })), l.notes && /* @__PURE__ */ React.createElement("p", { className: "text-sm text-[#6B6152] mt-3 italic border-l-2 border-[#D2C4B4] pl-2" }, l.notes)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "'Oswald', sans-serif" }, className: "text-xs font-semibold uppercase tracking-wide text-[#6B6152] mb-2" }, "SEO checklist"), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, SEO_CHECKLIST_FIELDS.map((f) => {
      var _a;
      return /* @__PURE__ */ React.createElement("label", { key: f.key, className: "flex items-center gap-2 text-sm cursor-pointer" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: !!((_a = l.seo) == null ? void 0 : _a[f.key]), onChange: () => toggleSeo(l.id, f.key), className: "accent-[#748067] w-4 h-4" }), f.label);
    })))));
  })), loaded && listings.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-8 text-center" }, !confirmReset ? /* @__PURE__ */ React.createElement("button", { onClick: () => setConfirmReset(true), className: "text-xs text-[#B7AC9B] hover:text-[#A9887B] flex items-center gap-1 mx-auto" }, /* @__PURE__ */ React.createElement(RotateCcw, { size: 12 }), " Reset all data") : /* @__PURE__ */ React.createElement("div", { className: "text-xs text-[#6B6152] flex items-center justify-center gap-2 flex-wrap" }, "Delete all ", listings.length, " listings? This can't be undone.", /* @__PURE__ */ React.createElement("button", { onClick: resetAll, className: "font-semibold text-[#A9887B]" }, "Yes, delete"), /* @__PURE__ */ React.createElement("button", { onClick: () => setConfirmReset(false), className: "font-semibold" }, "Cancel")))), showImport && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-30 p-0 sm:p-5" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#E9DBCE] w-full sm:max-w-md sm:rounded-sm max-h-[90vh] overflow-y-auto border-t-2 sm:border-2 border-[#2F3730]" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-5 py-4 border-b border-[#D2C4B4]" }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Oswald', sans-serif" }, className: "text-lg font-semibold uppercase" }, "Import from eBay"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowImport(false) }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "px-5 py-4 space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm text-[#4A4335] space-y-2" }, /* @__PURE__ */ React.createElement("p", null, "In Seller Hub, go to ", /* @__PURE__ */ React.createElement("strong", null, "Active listings"), ", select your items, then ", /* @__PURE__ */ React.createElement("strong", null, "Download reports \u2192 Active listings report"), " and export as CSV."), /* @__PURE__ */ React.createElement("p", { className: "text-[#6B6152]" }, "Items already on your manifest are matched by eBay item number (or SKU, or title) and won't be duplicated \u2014 only new items get added.")), /* @__PURE__ */ React.createElement(
    "input",
    {
      ref: fileInputRef,
      type: "file",
  ...
  }, className: "w-full border-2 border-dashed border-[#B7AC9B] rounded-sm py-8 flex flex-col items-center gap-2 text-[#6B6152] hover:border-[#2F3730] hover:text-[#2F3730] transition-colors" }, /* @__PURE__ */ React.createElement(Upload, { size: 22 }), " ", /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium" }, "Choose CSV file")), importError && /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-2 text-sm bg-[#EBDFD6] border border-[#A9887B] text-[#6B564C] px-3 py-2 rounded-sm" }, /* @__PURE__ */ React.createElement(AlertCircle, { size: 16, className: "flex-shrink-0 mt-0.5" }), " ", importError), importResult && /* @__PURE__ */ React.createElement("div", { className: "text-sm bg-[#E1E6D9] border border-[#748067] text-[#4A5641] px-3 py-3 rounded-sm space-y-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-semibold" }, "Import complete"), /* @__PURE__ */ React.createElement("p", null, importResult.added, " new item", importResult.added === 1 ? "" : "s", " added"), importResult.updated > 0 && /* @__PURE__ */ React.createElement("p", null, importResult.updated, " existing item(s) refreshed"), importResult.skippedDupe > 0 && /* @__PURE__ */ React.createElement("p", { className: "text-[#5F6B57]" }, importResult.skippedDupe, " already tracked, skipped"), importResult.skippedBlank > 0 && /* @__PURE__ */ React.createElement("p", { className: "text-[#5F6B57]" }, importResult.skippedBlank, " row(s) had no title, skipped"))), /* @__PURE__ */ React.createElement("div", { className: "px-5 py-4 border-t border-[#D2C4B4]" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setShowImport(false), className: "w-full py-2.5 rounded-sm text-sm font-semibold border border-[#D2C4B4]" }, "Done")))), showForm && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-30 p-0 sm:p-5" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#E9DBCE] w-full sm:max-w-md sm:rounded-sm max-h-[90vh] overflow-y-auto border-t-2 sm:border-2 border-[#2F3730]" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-5 py-4 border-b border-[#D2C4B4]" }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Oswald', sans-serif" }, className: "text-lg font-semibold uppercase" }, draft.id ? "Edit item" : "New item"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowForm(false) }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "px-5 py-4 space-y-3" }, /* @__PURE__ */ React.createElement(Field, { label: "Title" }, /* @__PURE__ */ React.createElement("input", { value: draft.title, onChange: (e) => setDraft({ ...draft, title: e.target.value }), className: "input", placeholder: "Vintage 1990s denim jacket, size M", autoFocus: true })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement(Field, { label: "SKU / item #" }, /* @__PURE__ */ React.createElement("input", { value: draft.sku, onChange: (e) => setDraft({ ...draft, sku: e.target.value }), className: "input", placeholder: "JK-1042" })), /* @__PURE__ */ React.createElement(Field, { label: "Category" }, /* @__PURE__ */ React.createElement("input", { value: draft.category, onChange: (e) => setDraft({ ...draft, category: e.target.value }), className: "input", placeholder: "Men's clothing" }))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement(Field, { label: "Priority" }, /* @__PURE__ */ React.createElement("select", { value: draft.priority, onChange: (e) => setDraft({ ...draft, priority: e.target.value }), className: "input" }, PRIORITIES.map((p) => /* @__PURE__ */ React.createElement("option", { key: p, value: p }, p[0].toUpperCase() + p.slice(1))))), /* @__PURE__ */ React.createElement(Field, { label: "Last updated" }, /* @__PURE__ */ React.createElement("input", { type: "date", value: draft.lastUpdated, onChange: (e) => setDraft({ ...draft, lastUpdated: e.target.value }), className: "input" }))), /* @__PURE__ */ React.createElement(Field, { label: "Notes (optional)" }, /* @__PURE__ */ React.createElement("textarea", { value: draft.notes, onChange: (e) => setDraft({ ...draft, notes: e.target.value }), className: "input", rows: 2, placeholder: "Photos look washed out, needs retake" }))), /* @__PURE__ */ React.createElement("div", { className: "px-5 py-4 border-t border-[#D2C4B4] flex gap-2" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setShowForm(false), className: "flex-1 py-2.5 rounded-sm text-sm font-semibold border border-[#D2C4B4]" }, "Cancel"), /* @__PURE__ */ React.createElement("button", { onClick: saveDraft, disabled: !draft.title.trim(), className: "flex-1 py-2.5 rounded-sm text-sm font-semibold bg-[#2F3730] text-[#E9DBCE] disabled:opacity-40 flex items-center justify-center gap-1.5", style: { fontFamily: "'Oswald', sans-serif", letterSpacing: "0.03em" } }, /* @__PURE__ */ React.createElement(Check, { size: 15, strokeWidth: 2.5 }), " ", draft.id ? "SAVE CHANGES" : "ADD TO MANIFEST")))));
}
...
function StatBlock({ label, value, accent }) {
  return /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-[#D2C4B4] rounded-sm px-3 py-2.5" }, /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "'IBM Plex Mono', monospace", color: accent || "#2F3730" }, className: "text-xl font-semibold leading-none" }, value), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] uppercase tracking-wide text-[#8C8878] mt-1 font-medium" }, label));
}
function PriorityTag({ priority }) {
  const map = {
    high: { bg: "#EBDFD6", text: "#A9887B" },
    medium: { bg: "#DCE0D2", text: "#6E7566" },
    low: { bg: "#DCE0D2", text: "#5E6E61" }
  };
